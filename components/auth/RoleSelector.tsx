    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      >
        <div
          className={cn(
            ...
            value === 'student' ? 'bg-primary' : 'bg-gray-100 group-hover:bg-primaryWeak'
          )}
        >
          <GraduationCap className="w-8 h-8" />
        </div>
        <h3 className="text-xl font-bold mb-2">I'm a Student</h3>
        <p className="text-sm text-muted">Find expert tutors and learn at your own pace</p>
      </button>
      ...
      >
        <div
          className={cn(
            'w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center transition-base',
            value === 'tutor' ? 'bg-primary' : 'bg-gray-100 group-hover:bg-primaryWeak'
          )}
        >
          <Users className="w-8 h-8" />
        </div>
        <h3 className="text-xl font-bold mb-2">I'm a Tutor</h3>
        <p className="text-sm text-muted">Share your knowledge and earn by teaching</p>
      </button>
    </div>
  );
}
