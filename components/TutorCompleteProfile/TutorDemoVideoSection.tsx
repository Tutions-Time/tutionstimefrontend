    ...
    <section className="bg-white rounded-2xl shadow p-8">
      ...
      {demoVideoFile && (
        <div className="mt-4 relative">
          <video controls className="w-full max-h-[420px] rounded-lg border" src={URL.createObjectURL(demoVideoFile)} />
          <button
            type="button"
      ...
      {errors.demoVideo && <p className="text-rose-600 text-xs mt-2">{errors.demoVideo}</p>}
    </section>
  );
}
